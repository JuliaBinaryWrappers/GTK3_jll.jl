...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GTK3_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("77ec8976-b24b-556a-a1bf-49a033a670a6"))
...
if best_platform === nothing
    @debug("Unable to load GTK3; unsupported platform $(triplet(platform_key_abi()))")
else
